...
export const MovingWidget: FC<AppProps> = ({ dashboardOid, widget, left = 0, top = 0, themeSettings, onWidgetDelete }) => {
    const [, drag] = useDrag(
        () => ({
            type: 'dashboard-item',
    ...
    return (
        <StyledMovingWidget key={widget.oid +"widgetDasboardBlock"} style={{ position: 'absolute', left, top }}
            ref={drag}>
